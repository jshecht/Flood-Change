...
# Model 5D (Method of moments, log trend in variance)
...
res_var[k] = length(wy_order)/(length(wy_order)-2)*var(res_reg1[[k]])
cond_med_at_n[k] = b0_reg1[k] + b1_reg1[k] * max(wy_order) 
cond_mean_at_n[k] = cond_med_at_n[k] + 0.5 * res_var[k] #Assuming heteroscedasticity
...
res_reg2_5a_var <- length(wy_order)/(length(wy_order)-2)*var(res_reg1_2_3-res_reg2_5a_fit)
cond_var_at_n_5a[k] = (cc0_5a[k] + cc1_5a[k] * max(wy_order))^3 + res_reg2_5a_var*(3*cc0_5a[k] + 3*cc1_5a[k] * max(wy_order)) + mean((res_reg1_2_3-res_reg2_5a_fit)^3)
...
res_reg2_5b_var <- length(wy_order)/(length(wy_order)-2)*var(res_reg1_2_3-res_reg2_5b_fit)
#cond_var_at_n_5b[k] = cc0_5b[k] + cc1_5b[k] * max(wy_order^2)
cond_var_at_n_5b[k] = (cc0_5b[k] + cc1_5b[k] * max(wy_order_2))^3 + res_reg2_5b_var*(3*cc0_5b[k] + 3*cc1_5b[k] * max(wy_order_2)) + mean((res_reg1_2_3-res_reg2_5b_fit)^3)
...
rho_t_res_reg2 <- cor(exp(wy_order),res_reg1_2_3)
sd_res_reg1_2_3 <- sd(res_reg1_2_3)
cc0_5c[k] = mean(res_reg1_2_3) - (rho_t_res_reg2 * sd_res_reg1_2_3  * mean(exp(wy_order)) / sd(exp(wy_order)))
cc1_5c[k] = rho_t_res_reg2 * sd_res_reg1_2_3 / sd(exp(wy_order))
res_reg2_5c_fit <- cc0_5c[k] + cc1_5c[k] * exp(wy_order)
res_reg2_5c_var <- length(wy_order)/(length(wy_order)-2)*var(res_reg1_2_3-res_reg2_5c_fit)
cond_var_at_n_5c[k] = (cc0_5c[k] + cc1_5c[k] * max(exp(wy_order)))^3 + res_reg2_5c_var*(3*cc0_5c[k] + 3*cc1_5c[k] * max(exp(wy_order))) + mean((res_reg1_2_3-res_reg2_5c_fit)^3)
...
se_cc0_5c <- sqrt(sum((res_reg1_2_3 - res_reg2_5c_fit)^2)/(length(wy_order) - 2)*(1/length(wy_order)+mean(exp(wy_order))^2/sum((exp(wy_order)-mean(exp(wy_order)))^2))) 
se_cc1_5c <- sqrt(sum((res_reg1_2_3 - res_reg2_5c_fit)^2)/((length(wy_order) - 2)*sum((exp(wy_order)-mean(exp(wy_order)))^2)))
...
cond_var_at_n_5d[k] = (cc0_5d[k] + cc1_5d[k] * max(log(wy_order)))^3 + res_reg2_5d_var*(3*cc0_5d[k] + 3*cc1_5d[k] * max(log(wy_order))) + mean((res_reg1_2_3-res_reg2_5d_fit)^3)
#cond_var_at_n_5d[k] = cc0_5d[k] + cc1_5d[k] * max(log(wy_order))
#plot(wy_order,res_reg1_2_3,col="blue")
...
cond_var_at_n_6a[k] = (cc0_6a[k,10] + cc1_6a[k,10] * max(wy_order))^3 + 
  var(res_reg1_iwls_2_3_6a[,10]-cond_var_6a[,10])*(3*cc0_6a[k,10] + 3*cc1_6a[k,10] * max(wy_order)) + mean((res_reg1_iwls_2_3_6a[,10]-cond_var_6a[,10])^3)
#plot(wy_order,res_reg1_2_3,col="blue")
#lines(wy_order,res_reg2_5a)
...
cond_var_at_n_6b[k] = (cc0_6b[k,10] + cc1_6b[k,10] * max(wy_order^2))^3 + 
  var(res_reg1_iwls_2_3_6b[,10]-cond_var_6b[,10])*(3*cc0_6b[k,10] + 3*cc1_6b[k,10] * max(wy_order^2)) + mean((res_reg1_iwls_2_3_6b[,10]-cond_var_6b[,10])^3)
#plot(wy_order,res_reg1_2_3,col="blue")
#lines(wy_order,res_reg2_5a)
...
cond_var_at_n_6d[k] = (cc0_6d[k,10] + cc1_6d[k,10] * max(log(wy_order)))^3 + 
  var(res_reg1_iwls_2_3_6d[,10]-cond_var_6d[,10])*(3*cc0_6d[k,10] + 3*cc1_6d[k,10] * max(log(wy_order))) + mean((res_reg1_iwls_2_3_6d[,10]-cond_var_6d[,10])^3)
#plot(wy_order,res_reg1_2_3,col="blue")
#lines(wy_order,res_reg2_5a)
