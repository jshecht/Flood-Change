...
station_group <- output_lin_mplus_sig05_vplus_sig05_clean
...
skew_ln_peak_flow[k] = skewness(log(peak_flow+0.01))
...
delta_b1_reg1_true <- 1/(sqrt(1/cor(wy_order[[k]],log(peak_flow+0.01))^2-1))
t_b1_reg1 <- abs(qt(1-pval_b1_reg1[k],length(wy_order[[k]])-2))
t2_error_b1_reg1[k] = pt(t_b1_reg1 - delta_b1_reg1_true*sqrt(length(wy_order[[k]])),length(wy_order[[k]])-2)
...
# Type II errors using methods from Vogel et al. (2013) and Rosner et al. (2014)
delta_cc1_5a_true <- 1/(sqrt(1/cor(wy_order[[k]],res_reg1_2_3)^2-1))
t_cc1_5a <- abs(qt(1-p_cc1_5a[k],length(wy_order[[k]])-2))
t2_error_cc1_5a[k] = pt(t_cc1_5a - delta_cc1_5a_true*sqrt(length(wy_order[[k]])),length(wy_order[[k]])-2)
...
plot((Q_99_at_n_med_only-Q_99_at_n_no_trend)/Q_99_at_n_no_trend*100,
     (Q_99_at_n_5a - Q_99_at_n_med_only)/Q_99_at_n_no_trend*100,
...
#points(Q_99_at_n_5a_mean_mplus_vminus_amp,Q_99_at_n_5a_Cv_mplus_vminus_amp)
...
#Q_99_at_n_5a_mean_mplus_vminus_amp <- (Q_99_at_n_med_only-Q_99_at_n_no_trend)/Q_99_at_n_no_trend*100
#Q_99_at_n_5a_Cv_mplus_vminus_amp <- (Q_99_at_n_5a-Q_99_at_n_med_only)/Q_99_at_n_no_trend*100

#rsquared_5a_vminus <- rsquared_5a
