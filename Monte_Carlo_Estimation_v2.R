...
# Check range of Cv of combinations
cv_yy <- array(NA,dim=c(length=mm,length(bb0_true),length(bb1_true),length(cc0_true),length(cc1_true)))
...
boxplot(rbias_ee_2,rbias_ee_2_3,rbias_ee_2_3_MoM,rbias_iwls_ee_2_3,rbias_glm_ee_2,rbias_iwls_glm_ee_2,
        names=c("ee_2","ee_2_3","ee_2_3_MoM","iwls_ee_2_3","glm_ee_2","iwls_glm_ee_2"),ylab="Relative bias (%)",
        ylim=c(-0.1,0.1),cex.axis=0.8)
abline(h = 0,lty=4)
...
boxplot(rrmse_ee_2,rrmse_ee_2_3,rrmse_ee_2_3_MoM,rrmse_iwls_ee_2_3,rrmse_glm_ee_2,rrmse_iwls_glm_ee_2,
        names=c("ee_2","ee_2_3","ee_2_3_MoM","iwls_ee_2_3","glm_ee_2","iwls_glm_ee_2"),
        ylab="Relative RMSE",cex.axis=0.8, main="Quantile estimate RMSE")
