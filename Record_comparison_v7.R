...
station_group_time <- rbind(output_lin_mplus_sig05_vminus_sig05_time,
                       output_lin_mplus_sig05_vplus_sig05_time)
...
wy_order_time  <- list()
wy_order_2_time  <- list()
wy_order_mean_time  <- vector(length=nrow(station_group_time))
wy_order_max_time <- vector(length=nrow(station_group_time))

skew_peak_flow_time  <- vector(length=nrow(station_group_time))
cv_peak_flow_time  <- vector(length=nrow(station_group_time))
skew_ln_peak_flow_time  <- vector(length=nrow(station_group_time))

b0_reg1_time  <- vector(length=nrow(station_group_time))
b1_reg1_time  <- vector(length=nrow(station_group_time))
rho_reg1_time  <- vector(length=nrow(station_group_time))
pval_b0_reg1_time  <- vector(length=nrow(station_group_time))
pval_b1_reg1_time  <- vector(length=nrow(station_group_time))
rsquared_reg1_time  <- vector(length=nrow(station_group_time))
# FIX: Look into res_dof_corr
res_dof_corr_time  <- vector(length=nrow(station_group_time))
adj_r2_corr_time  <- vector(length=nrow(station_group_time))
res_reg1_time <- list()
res_var_time  <- vector(length=nrow(station_group_time))
cond_med_at_n_time  <- vector(length=nrow(station_group_time))
cond_mean_at_n_time <- vector(length=nrow(station_group_time)) # Accounts for transformation bias
Q_99_at_n_med_only_time<- vector(length=nrow(station_group_time))
Q_99_at_n_no_trend_time <- vector(length=nrow(station_group_time))

# Type II error analysis 
delta_b1_reg1_true_time <- vector(length=nrow(station_group_time))
tt_b1_reg1_time <- vector(length=nrow(station_group_time))
t2_error_b1_reg1_time <- vector(length=nrow(station_group_time))

# Two-stage least squares - Model A
b0_reg2_0a_time <- vector(length=nrow(station_group_time))
b1_reg2_0a_time <- vector(length=nrow(station_group_time))
pval_b0_reg2_0a_time <- vector(length=nrow(station_group_time))
pval_b1_reg2_0a_time <- vector(length=nrow(station_group_time))
adj_rsquared_reg2_0a_time <- vector(length=nrow(station_group_time))
res_reg2_0a_time <- list()
cond_var_at_n_2sls_0a_time <- vector(length=nrow(station_group_time)) 
Q_99_at_n_2sls_0a_time <- vector(length=nrow(station_group_time)) 

# Two-stage least squares - Model B
b0_reg2_0b_time <- vector(length=nrow(station_group_time))
b1_reg2_0b_time <- vector(length=nrow(station_group_time))
pval_b0_reg2_0b_time <- vector(length=nrow(station_group_time))
pval_b1_reg2_0b_time <- vector(length=nrow(station_group_time))
adj_rsquared_reg2_0b_time <- vector(length=nrow(station_group_time))
res_reg2_0b_time <- list()
cond_var_at_n_2sls_0b_time <- vector(length=nrow(station_group_time)) 
Q_99_at_n_2sls_0b_time <- vector(length=nrow(station_group_time)) 

# Two-stage least squares without Anscombe residuals - Model A
b0_reg2_1a_time <- vector(length=nrow(station_group_time))
b1_reg2_1a_time <- vector(length=nrow(station_group_time))
pval_b0_reg2_1a_time <- vector(length=nrow(station_group_time))
pval_b1_reg2_1a_time <- vector(length=nrow(station_group_time))
adj_rsquared_reg2_1a_time <- vector(length=nrow(station_group_time))
res_reg2_1a_time <- list()
cond_var_at_n_2sls_1a_time <- vector(length=nrow(station_group_time)) 
Q_99_at_n_2sls_1a_time <- vector(length=nrow(station_group_time))

# Two-stage least squares without Anscombe residuals - Model B
b0_reg2_1b_time <- vector(length=nrow(station_group_time))
b1_reg2_1b_time <- vector(length=nrow(station_group_time))
pval_b0_reg2_1b_time <- vector(length=nrow(station_group_time))
pval_b1_reg2_1b_time <- vector(length=nrow(station_group_time))
adj_rsquared_reg2_1b_time <- vector(length=nrow(station_group_time))
res_reg2_1b_time <- list()
cond_var_at_n_2sls_1b_time <- vector(length=nrow(station_group_time))
Q_99_at_n_2sls_1b_time <- vector(length=nrow(station_group_time))


# Two-parameter derived model - Model A 
cond_var_at_n_2a_time <- vector(length=nrow(station_group_time))
Q_99_at_n_2a_time <- vector(length=nrow(station_group_time))

# Two-parameter derived model - Model B
cond_var_at_n_2b_time <- vector(length=nrow(station_group_time)) 
Q_99_at_n_2b_time <- vector(length=nrow(station_group_time)) 

# Three-parameter model - Model A
cc1_3a_time <- vector(length=nrow(station_group_time))
rsquared_3a_time <- vector(length=nrow(station_group_time))
cond_var_at_n_3a_time <- vector(length=nrow(station_group_time))
Q_99_at_n_3a_time <- vector(length=nrow(station_group_time))

# Three-parameter model - Model C
cc1_3c_time <- vector(length=nrow(station_group_time))
rsquared_3c_time <- vector(length=nrow(station_group_time))
cond_var_at_n_3c_time <- vector(length=nrow(station_group_time))
Q_99_at_n_3c_time <- vector(length=nrow(station_group_time))

# Four-parameter - Model A
res_mult1_4a_time <- list()
cond_var_4a_time <- list()
cond_var_at_n_4a_time <- vector(length=nrow(station_group_time))
Q_99_at_n_4a_time <- vector(length=nrow(station_group_time))

# Model 5A (Method of moments, linear trend in variance)
cc0_5a_time <- vector(length=nrow(station_group_time))
cc1_5a_time <- vector(length=nrow(station_group_time))
rsquared_5a_time <- vector(length=nrow(station_group_time))
adj_rsquared_5a_time <- vector(length=nrow(station_group_time))
rmse_5a_time <- vector(length=nrow(station_group_time))
rrmse_5a_time <- vector(length=nrow(station_group_time))
mape_5a_time <- vector(length=nrow(station_group_time))
cond_var_5a_time <- list()
cond_var_at_n_5a_time <- vector(length=nrow(station_group_time))
Q_99_at_n_5a_time <- vector(length=nrow(station_group_time))
t_cc1_5a_time <- vector(length=nrow(station_group_time))
p_cc0_5a_time <- vector(length=nrow(station_group_time))
p_cc1_5a_time <- vector(length=nrow(station_group_time)) 

zp_RI_if_stnry_5a_time <- vector(length=nrow(station_group_time)) 
RI_if_stnry_5a_time <- vector(length=nrow(station_group_time)) 

delta_cc1_5a_true_time <- vector(length=nrow(station_group_time))
tt_cc1_5a_time <- vector(length=nrow(station_group_time))
t2_error_cc1_5a_time <- vector(length=nrow(station_group_time))

pval_ppcc_res_reg2_5a_time <- vector(length=nrow(station_group_time))
pval_dw_res_reg2_5a_time <- vector(length=nrow(station_group_time))
p_dd1_5a_time <- vector(length=nrow(station_group_time))

# Model 5B (Method of moments, quadratic trend in variance)
cc0_5b_time <- vector(length=nrow(station_group_time))
cc1_5b_time <- vector(length=nrow(station_group_time))
rsquared_5b_time <- vector(length=nrow(station_group_time))
adj_rsquared_5b_time <- vector(length=nrow(station_group_time))
rmse_5b_time <- vector(length=nrow(station_group_time))
rrmse_5b_time <- vector(length=nrow(station_group_time))

cond_var_5b_time <- list()
cond_var_at_n_5b_time <- vector(length=nrow(station_group_time))
Q_99_at_n_5b_time <- vector(length=nrow(station_group_time))
p_cc0_5b_time <- vector(length=nrow(station_group_time))
p_cc1_5b_time <- vector(length=nrow(station_group_time)) 

pval_ppcc_res_reg2_5b_time <- vector(length=nrow(station_group_time))
pval_dw_res_reg2_5b_time <- vector(length=nrow(station_group_time))
p_dd1_5b_time <- vector(length=nrow(station_group_time))

# Model 5C (Method of moments, log trend in variance)
cc0_5c_time <- vector(length=nrow(station_group_time))
cc1_5c_time <- vector(length=nrow(station_group_time))
rsquared_5c_time <- vector(length=nrow(station_group_time))
adj_rsquared_5c_time <- vector(length=nrow(station_group_time))
rmse_5c_time <- vector(length=nrow(station_group_time))
rrmse_5c_time <- vector(length=nrow(station_group_time))

cond_var_5c_time <- list()
cond_var_at_n_5c_time <- vector(length=nrow(station_group_time))

Q_99_at_n_5c_time <- vector(length=nrow(station_group_time))
p_cc0_5_timec <- vector(length=nrow(station_group_time))
p_cc1_5c_time <- vector(length=nrow(station_group_time)) 

pval_ppcc_res_reg2_5c_time <- vector(length=nrow(station_group_time))
pval_dw_res_reg2_5c_time <- vector(length=nrow(station_group_time))
p_dd1_5c_time <- vector(length=nrow(station_group_time))

# Model 5D (Method of moments, logarithmic trend in variance)
cc0_5d_time <- vector(length=nrow(station_group_time))
cc1_5d_time <- vector(length=nrow(station_group_time))
rsquared_5d_time <- vector(length=nrow(station_group_time))
adj_rsquared_5d_time <- vector(length=nrow(station_group_time))
rmse_5d_time <- vector(length=nrow(station_group_time))
rrmse_5d_time <- vector(length=nrow(station_group_time))

cond_var_5d_time <- list()
cond_var_at_n_5d_time <- vector(length=nrow(station_group_time))

Q_99_at_n_5d_time <- vector(length=nrow(station_group_time))
p_cc0_5d_time <- vector(length=nrow(station_group_time))
p_cc1_5d_time <- vector(length=nrow(station_group_time)) 

pval_ppcc_res_reg2_5d_time <- vector(length=nrow(station_group_time))
pval_dw_res_reg2_5d_time <- vector(length=nrow(station_group_time))
p_dd1_5d_time <- vector(length=nrow(station_group_time))

# Model 5E (Method of moments, log-transformed squared residuals)
cc0_5e_time <- vector(length=nrow(station_group_time))
cc1_5e_time <- vector(length=nrow(station_group_time))
rsquared_5e_time <- vector(length=nrow(station_group_time))
adj_rsquared_5e_time <- vector(length=nrow(station_group_time))
rmse_5e_time <- vector(length=nrow(station_group_time))
rrmse_5e_time <- vector(length=nrow(station_group_time))

cond_var_5e_time <- list()
cond_var_at_n_5e_time <- vector(length=nrow(station_group_time))
Q_99_at_n_5e_time <- vector(length=nrow(station_group_time))
p_cc0_5e_time <- vector(length=nrow(station_group_time))
p_cc1_5e_time <- vector(length=nrow(station_group_time)) 

pval_ppcc_res_reg2_5e_time <- vector(length=nrow(station_group_time))
pval_dw_res_reg2_5e_time <- vector(length=nrow(station_group_time))
p_dd1_5e_time <- vector(length=nrow(station_group_time))

# Model 5F (Method of moments, direct estimation s.d.)
cc0_5f_time <- vector(length=nrow(station_group_time))
cc1_5f_time <- vector(length=nrow(station_group_time))
rsquared_5f_time <- vector(length=nrow(station_group_time))
adj_rsquared_5f_time <- vector(length=nrow(station_group_time))
rmse_5f_time <- vector(length=nrow(station_group_time))
rrmse_5f_time <- vector(length=nrow(station_group_time))

cond_var_5f_time <- list()
cond_var_at_n_5f_time <- vector(length=nrow(station_group_time))
Q_99_at_n_5f_time <- vector(length=nrow(station_group_time))
p_cc0_5f_time <- vector(length=nrow(station_group_time))
p_cc1_5f_time <- vector(length=nrow(station_group_time)) 

pval_ppcc_res_reg2_5f_time <- vector(length=nrow(station_group_time))
pval_dw_res_reg2_5f_time <- vector(length=nrow(station_group_time))
p_dd1_5f_time <- vector(length=nrow(station_group_time))

# Model 6A (IWLS, linear trend in variance)
b0_reg1_iwls_6a_time <- matrix(nrow=nrow(station_group_time),ncol=10)
b1_reg1_iwls_6a_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc0_6a_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc1_6a_time <- matrix(nrow=nrow(station_group_time),ncol=10)

wt_6a_list_time <- list()
res_reg1_iwls_6a_list_time <- list()
res_reg1_iwls_2_3_6a_list_time <- list()
cond_var_6a_list_time <- list()

rsquared_6a_time <- vector(length=nrow(station_group_time))
adj_rsquared_6a_time <- vector(length=nrow(station_group_time))
rmse_6a_time <- vector(length=nrow(station_group_time))
rrmse_6a_time <- vector(length=nrow(station_group_time))

cond_var_at_n_6a_time <- vector(length=nrow(station_group_time))
Q_99_at_n_6a_time <- vector(length=nrow(station_group_time))
p_cc1_6a_time <- vector(length=nrow(station_group_time)) 

# Model 6B (IWLS, quadratic trend in variance)
b0_reg1_iwls_6b_time <- matrix(nrow=nrow(station_group_time),ncol=10)
b1_reg1_iwls_6b_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc0_6b_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc1_6b_time <- matrix(nrow=nrow(station_group_time),ncol=10)

wt_6b_list_time <- list()
res_reg1_iwls_6b_list_time <- list()
res_reg1_iwls_2_3_6b_list_time <- list()
cond_var_6b_list_time <- list()

rsquared_6b_time <- vector(length=nrow(station_group_time))
adj_rsquared_6b_time <- vector(length=nrow(station_group_time))
rmse_6b_time <- vector(length=nrow(station_group_time))
rrmse_6b_time <- vector(length=nrow(station_group_time))

cond_var_at_n_6b_time <- vector(length=nrow(station_group_time))
Q_99_at_n_6b_time <- vector(length=nrow(station_group_time))
p_cc1_6b_time <- vector(length=nrow(station_group_time)) 

# Model 6c (IWLS, exponential trend in variance)
b0_reg1_iwls_6c_time <- matrix(nrow=nrow(station_group_time),ncol=10)
b1_reg1_iwls_6c_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc0_6c_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc1_6c_time <- matrix(nrow=nrow(station_group_time),ncol=10)

wt_6c_list_time <- list()
res_reg1_iwls_6c_list_time <- list()
res_reg1_iwls_2_3_6c_list_time <- list()
cond_var_6c_list_time <- list()

rsquared_6c_time <- vector(length=nrow(station_group_time))
adj_rsquared_6c_time <- vector(length=nrow(station_group_time))
rmse_6c_time <- vector(length=nrow(station_group_time))
rrmse_6c_time <- vector(length=nrow(station_group_time))

cond_var_at_n_6c_time <- vector(length=nrow(station_group_time))
Q_99_at_n_6c_time <- vector(length=nrow(station_group_time))
p_cc1_6c_time <- vector(length=nrow(station_group_time))

# Model 6d (IWLS, logarithmic trend in variance)
b0_reg1_iwls_6d_time <- matrix(nrow=nrow(station_group_time),ncol=10)
b1_reg1_iwls_6d_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc0_6d_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc1_6d_time <- matrix(nrow=nrow(station_group_time),ncol=10)

wt_6d_list_time <- list()
res_reg1_iwls_6d_list_time <- list()
res_reg1_iwls_2_3_6d_list_time <- list()
cond_var_6d_list_time <- list()

rsquared_6d_time <- vector(length=nrow(station_group_time))
adj_rsquared_6d_time <- vector(length=nrow(station_group_time))
rmse_6d_time <- vector(length=nrow(station_group_time))
rrmse_6d_time <- vector(length=nrow(station_group_time))

cond_var_at_n_6d_time <- vector(length=nrow(station_group_time))
Q_99_at_n_6d_time <- vector(length=nrow(station_group_time))
p_cc1_6d_time <- vector(length=nrow(station_group_time))

# GLM - Model A 
b0_glm_cond_var_a_time <- vector(length=nrow(station_group_time))
b1_glm_cond_var_a_time <- vector(length=nrow(station_group_time)) 
pseudo_rsquared_glm_a_time <- vector(length=nrow(station_group_time)) 
cond_var_at_n_glm_a_time <- vector(length=nrow(station_group_time)) 
Q_99_at_n_glm_a_time <- vector(length=nrow(station_group_time))

# Gamma GLM model without IWLS
b0_glm_cond_var_gamma_time <- vector(length=nrow(station_group_time))
b1_glm_cond_var_gamma_time <- vector(length=nrow(station_group_time)) 
pseudo_rsquared_glm_gamma_time <- vector(length=nrow(station_group_time)) 
cond_var_at_n_glm_gamma_time <- vector(length=nrow(station_group_time)) 
Q_99_at_n_glm_gamma_time <- vector(length=nrow(station_group_time))

# Gamma GLM model with IWLS
b0_reg1_iwls_glm_gamma_time <- matrix(nrow=nrow(station_group_time),ncol=10)
b1_reg1_iwls_glm_gamma_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc0_iwls_glm_gamma_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc1_iwls_glm_gamma_time <- matrix(nrow=nrow(station_group_time),ncol=10)
res_reg1_iwls_glm_gamma_time <- matrix(nrow=nrow(station_group_time),ncol=10)
res_reg1_2_iwls_glm_gamma_time <- matrix(nrow=nrow(station_group_time),ncol=10)

wt_iwls_glm_gamma_list_time <- list()
res_reg1_iwls_glm_gamma_list_time <- list()
res_reg1_2_iwls_glm_gamma_list_time <- list()
cvar_iwls_glm_gamma_list_time <- list()

rsquared_iwls_glm_gamma_time <- vector(length=nrow(station_group_time))
adj_rsquared_iwls_glm_gamma_time <- vector(length=nrow(station_group_time))
rmse_iwls_glm_gamma_time <- vector(length=nrow(station_group_time))
rrmse_iwls_glm_gamma_time <- vector(length=nrow(station_group_time))

cond_var_at_n_iwls_glm_gamma_time <- vector(length=nrow(station_group_time))
Q_99_at_n_iwls_glm_gamma_time <- vector(length=nrow(station_group_time))
p_cc1_iwls_glm_gamma_time <- vector(length=nrow(station_group_time)) 

# Gamma GLM model with IWLS - quadratic
b0_reg1_iwls_glm_gamma_7b_time <- matrix(nrow=nrow(station_group_time),ncol=10)
b1_reg1_iwls_glm_gamma_7b_time<- matrix(nrow=nrow(station_group_time),ncol=10)
cc0_iwls_glm_gamma_7b_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc1_iwls_glm_gamma_7b_time <- matrix(nrow=nrow(station_group_time),ncol=10)
res_reg1_iwls_glm_gamma_7b_time <- matrix(nrow=nrow(station_group_time),ncol=10)
res_reg1_2_iwls_glm_gamma_7b_time <- matrix(nrow=nrow(station_group_time),ncol=10)

wt_iwls_glm_gamma_7b_list_time <- list()
res_reg1_iwls_glm_gamma_7b_list_time <- list()
res_reg1_2_iwls_glm_gamma_7b_list_time <- list()
cvar_iwls_glm_gamma_7b_list_time <- list()

rsquared_iwls_glm_gamma_7b_time <- vector(length=nrow(station_group_time))
adj_rsquared_iwls_glm_gamma_7b_time <- vector(length=nrow(station_group_time))
rmse_iwls_glm_gamma_7b_time <- vector(length=nrow(station_group_time))
rrmse_iwls_glm_gamma_7b_time <- vector(length=nrow(station_group_time))

cond_var_at_n_iwls_glm_gamma_7b_time <- vector(length=nrow(station_group_time))
Q_99_at_n_iwls_glm_gamma_7b_time <- vector(length=nrow(station_group_time))
p_cc1_iwls_glm_gamma_7b_time <- vector(length=nrow(station_group_time)) 

# Gamma GLM model with IWLS - logarithmic
b0_reg1_iwls_glm_gamma_7d_time <- matrix(nrow=nrow(station_group_time),ncol=10)
b1_reg1_iwls_glm_gamma_7d_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc0_iwls_glm_gamma_7d_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc1_iwls_glm_gamma_7d_time <- matrix(nrow=nrow(station_group_time),ncol=10)
res_reg1_iwls_glm_gamma_7d_time <- matrix(nrow=nrow(station_group_time),ncol=10)
res_reg1_2_iwls_glm_gamma_7d_time <- matrix(nrow=nrow(station_group_time),ncol=10)

wt_iwls_glm_gamma_7d_list_time <- list()
res_reg1_iwls_glm_gamma_7d_list_time <- list()
res_reg1_2_iwls_glm_gamma_7d_list_time <- list()
cvar_iwls_glm_gamma_7d_list_time <- list()

rsquared_iwls_glm_gamma_7d_time <- vector(length=nrow(station_group_time))
adj_rsquared_iwls_glm_gamma_7d_time <- vector(length=nrow(station_group_time))
rmse_iwls_glm_gamma_7d_time <- vector(length=nrow(station_group_time))
rrmse_iwls_glm_gamma_7d_time <- vector(length=nrow(station_group_time))

cond_var_at_n_iwls_glm_gamma_7d_time <- vector(length=nrow(station_group_time))
Q_99_at_n_iwls_glm_gamma_7d_time <- vector(length=nrow(station_group_time))
p_cc1_iwls_glm_gamma_7d_time <- vector(length=nrow(station_group_time)) 

# Gamma GLM model with IWLS - standard deviation
b0_reg1_iwls_glm_gamma_7f_time <- matrix(nrow=nrow(station_group_time),ncol=10)
b1_reg1_iwls_glm_gamma_7f_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc0_iwls_glm_gamma_7f_time <- matrix(nrow=nrow(station_group_time),ncol=10)
cc1_iwls_glm_gamma_7f_time <- matrix(nrow=nrow(station_group_time),ncol=10)
res_reg1_iwls_glm_gamma_7f_time <- matrix(nrow=nrow(station_group_time),ncol=10)
res_reg1_abs_iwls_glm_gamma_7f_time <- matrix(nrow=nrow(station_group_time),ncol=10)

wt_iwls_glm_gamma_7f_list_time <- list()
res_reg1_iwls_glm_gamma_7f_list_time <- list()
res_reg1_abs_iwls_glm_gamma_7f_list_time <- list()
cvar_iwls_glm_gamma_7f_list_time <- list()

rsquared_iwls_glm_gamma_7f_time <- vector(length=nrow(station_group_time))
adj_rsquared_iwls_glm_gamma_7f_time <- vector(length=nrow(station_group_time))
rmse_iwls_glm_gamma_7f_time <- vector(length=nrow(station_group_time))
rrmse_iwls_glm_gamma_7f_time <- vector(length=nrow(station_group_time))

cond_var_at_n_iwls_glm_gamma_7f_time <- vector(length=nrow(station_group_time))
Q_99_at_n_iwls_glm_gamma_7f_time <- vector(length=nrow(station_group_time))
p_cc1_iwls_glm_gamma_7f_time <- vector(length=nrow(station_group_time)) 
...
# FIX: 1Compare R2 of +mean,-Cv and + mean,+Cv
